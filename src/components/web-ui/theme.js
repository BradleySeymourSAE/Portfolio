const theme = {
  ...
  fontSizes: ['0.8rem', '1rem', '1.1em', '1.2rem', '1.4rem', '1.6rem', '2rem', '2.5rem', '3rem', '4rem'],
  ...
  shadow: {
    depth0: 'none !important',
    depth1: '0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 3px 1px -2px rgba(0, 0, 0, 0.12), 0 1px 5px 0 rgba(0, 0, 0, 0.2)',
    depth2: '0 4px 5px 0 rgba(0, 0, 0, 0.14), 0 1px 10px 0 rgba(0, 0, 0, 0.12), 0 2px 4px -1px rgba(0, 0, 0, 0.3)',
    depth3: '0 8px 17px 2px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12), 0 5px 5px -3px rgba(0, 0, 0, 0.2)',
    depth4: '0 16px 24px 2px rgba(0, 0, 0, 0.14), 0 6px 30px 5px rgba(0, 0, 0, 0.12), 0 8px 10px -7px rgba(0, 0, 0, 0.2)',
    depth5: '0 24px 38px 3px rgba(0, 0, 0, 0.14), 0 9px 46px 8px rgba(0, 0, 0, 0.12), 0 11px 15px -7px rgba(0, 0, 0, 0.2)',
  },
  gradients: {
    deepSea: `linear-gradient(to right, #2C3E50, #4CA1AF)`,
    orangePurple: `linear-gradient(to left, #e96443, #904e95)`,
    lightBlueDark: `linear-gradient(to left, #3a7bd5, #3a6073)`,
    brightBlueDark: `linear-gradient(to right, #00d2ff, #928dab)`,
    brightBlueOrange: `linear-gradient(to bottom, #2196f3, #f44336)`,
    sunset: `linear-gradient(45deg, #FF5F6D, #ffc371)`,
    darkOrangeLight: `linear-gradient(45deg, #ff4b1f, #ff9068)`,
    bluePurple: `linear-gradient(to left, #16bffd, #cb0366)`,
    peachPink: `linear-gradient(45deg, #eecda3, #ef629f)`,
    sincityRed: `linear-gradient(to right, #ed213a, #93291e)`,
  },
  radius: {
    sml: '6.5px',
    reg: '10px',
  ...
  font: '"Poppins", "Quicksand", "Rubik", "Roboto", "Montserrat", sans-serif',
